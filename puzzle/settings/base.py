"""
Django settings for pazl project.
...
SECRET_KEY = '#+%&v5dmdaey8t0&(7i$0f&wsbfmp%(+_2#!6$1nnc%39mdg&4'
...
try:
    with open(os.path.join(BASE_DIR, 'pazl.config.json')) as config_file:
        content = config_file.read()
        data = json.loads(content)
        if 'PAZL_BASE_PATH' in data:
            PAZL_BASE_PATH = data['PAZL_BASE_PATH']
except Exception as e:
    print('Unable to read "pazl.config.json":', e)
